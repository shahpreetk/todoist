...
const AddProject = ({shouldShow = false}) => {
    ...
    return (
        <div className='add-project' data-testid='add-project'>
            ...
            <span aria-label='Add Project' data-testid='add-project-action' className='add-project__text' onClick={()=>setShow(!show)} onKeyDown={()=>setShow(!show)} role='button' tabIndex={0}>Add Project</span>
        </div>
    )
}
