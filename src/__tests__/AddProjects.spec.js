...
describe('<AddProjects />', () => {
  describe('Success', () => {
    it('renders <AddProjects />', () => {
      const { queryByTestId } = render(<AddProjects />);
      expect(queryByTestId('add-project')).toBeTruthy();
    });

    it('renders <AddProjects /> and adds a project using onClick', () => {
      const { queryByTestId } = render(<AddProjects shouldShow />);
      expect(queryByTestId('add-project')).toBeTruthy();
    ...
    it('hides the project overlay when cancelled using onClick', () => {
      const { queryByTestId, getByText } = render(<AddProjects shouldShow />);
      expect(queryByTestId('add-project')).toBeTruthy();
